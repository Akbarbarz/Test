...
console.log(color('> HARI ','silver'), color(`${tampilHari}\n`,'mediumseagreen'))
	kurr.browserDescription = [ 'Akbarbarz', 'ubuntu', '3.0' ]
	...
	kurr.on('credentials-updated', () => {
		...
		info('2', 'Akbar Botz AB07 Loading...')
	})
...
kurr.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "6283890109310@s.whatsapp.net"
...
kurr.on('group-update', async (anu) => {
    ...
    kurr.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6283890109310@s.whatsapp.net","14242796410@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "14242796410@s.whatsapp.net"
